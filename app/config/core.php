 ...
 */
	Configure::write('Session.cookie', 'BLACKRABBIT_SESSION');
 ...
 */
	Configure::write('Security.salt', 'feAaép,pvkvD^`ç@526@\}]=)\ZDfz/eL$fCN.jOtycK,¤$*65qsSFZCcd4µ£ju456mv,dvi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7418546132729981321638489424324372127168239752625679327');
